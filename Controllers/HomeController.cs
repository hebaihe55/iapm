...
namespace iapm.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Prize()
        {
            ...
            return View(q.OrderByDescending(o => o.iconcount).ToList());
        ...
        public ActionResult Game()
        {
            ...
            ac.gardenFee = minj + Utils.Utils.getRandom().Next(1,maxj-minj);
            ...
            int jfk = Utils.Utils.getRandom().Next(1, 100);
        ...
        public ActionResult Login(string code)
        {
            ...
            {
                Response.Redirect("https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + Utils.WeHelper.appid + "&redirect_uri=http://ifc.cjoy.cn/home/Login&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect");
            }
        ...
        public string   addCard(string id)
        {
            try
            {
               ...
               c.OpenId = System.Web.HttpContext.Current.Session["uid"].ToString();
                ...
                c.CCtime = DateTime.Now;
                c.CardCode = "2016"+card.card_id;
            ...
            catch (Exception ex)
            {
                ...
                Utils.Log.Error("cardAdd", ex.Message);
            }
        ...
        public ActionResult EnGame()
        {
            ...
            Random rd = Utils.Utils.getRandom();
            int minj = 0;
            int maxj = 0;
